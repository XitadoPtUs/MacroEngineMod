...
object KeyboardUtils {
    ...
    fun isKeyPressed(raw: String): Boolean {
        ...
        return InputConstants.isKeyDown(Minecraft.getInstance().window, code)
    }
    ...
    fun isInputPressed(raw: String): Boolean {
        ...
        if (mouse != null) {
            return GLFW.glfwGetMouseButton(Minecraft.getInstance().window.handle(), mouse) == GLFW.GLFW_PRESS
        }
